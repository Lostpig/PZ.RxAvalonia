...
public class MaxValueValidation<T>(T maxValue) : IDataValidation<T> where T : IComparable<T>
{
...
public class MinValueValidation<T>(T minValue) : IDataValidation<T> where T : IComparable<T>
{
...
public static class DataValidations
{
    ...
    public static MaxValueValidation<T> MaxValue<T>(T maxValue) where T : IComparable<T> => new(maxValue);
    public static MinValueValidation<T> MinValue<T>(T minValue) where T : IComparable<T> => new(minValue);
}
