...
using PZ.ExtensionGenerator.Generators;

namespace PZ.ExtensionGenerator;
...
public class GeneratorHost(ExtensionGeneratorConfig config)
{
    ...
    private void GenerateExtensions()
    {
        ...
        foreach (var controlType in config.TypesToProcess)
        {
            ...
            sb.AppendLine();
            sb.AppendLine("namespace PZ.RxAvalonia;");
            sb.AppendLine($@"[global::System.CodeDom.Compiler.GeneratedCode(""PZ.AvaloniaExtensionGenerator"", ""{versionString}"")]");
