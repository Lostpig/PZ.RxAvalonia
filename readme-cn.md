# PZ.RxAvlonia
*PZ.RxAvlonia* 修改自 *Avalonia.Markup.Declarative* ( https://github.com/AvaloniaUI/Avalonia.Markup.Declarative ).

用纯C#来开发Avalonia UI

使用了 Rx.Net( https://github.com/dotnet/reactive ) 实现响应式组件.

## Installation

使用NuGet添加 `PZ.RxAvlonia` 到项目中
...
//code part
    ...
    private void OnButtonClick(RoutedEventArgs e)
    {
        ...
        Title = "Changed!";
        UpdateState();  // 使用Func赋值属性需要调用 UpdateState 刷新
    }
}
```
